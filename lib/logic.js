...
function onBootstrap(txn) {
    ...
    duck.firstName = "Duck";
    duck.lastName = "Aflac";
    duck.password = "aflac aflac aflac";
    duck.title = "Lead Insurance Agent";
    duck.company = 'AFLAC_CORP';
    agents.push(duck);
...
function onAssignPrimaryAgent(txn) {
    ...
    return getAssetRegistry(CLAIM)
          .then(function(claimRegistry) {
              ...
              return claimRegistry.update(txn.claim);
          }
    );
}
